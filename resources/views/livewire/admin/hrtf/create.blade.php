<div>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <p class="text-center font-bold">ADICIONAR NOVA HRTF</p>
            <div class="px-4 pt-8">
                <form wire:submit="save" class="flex flex-col gap-2">
                    <label class="font-bold">Digite o nome:</label>
                    <input class="w-full rounded" type="text" wire:model="form.name" placeholder="Fabian 30° azimuth">
                    ...
                    <label class="font-bold">Azimuth:</label>
                    <input class="w-full rounded" type="number" wire:model="form.azimuth" step=".1" placeholder="30">
                    <label class="font-bold">Ângulo de elevação:</label>
                    <input class="w-full rounded" type="number" wire:model="form.elevation_angle" step=".1" placeholder="0">
